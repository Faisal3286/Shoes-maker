...
export const Home = ()=>{
    ...
    return(
        <div>
           <img className={classes.bg} src={'https://hips.hearstapps.com/amv-prod-gp.s3.amazonaws.com/gearpatrol/wp-content/uploads/2020/06/Nike-Super-Rep-Gear-Patrol-Lead-Full.jpg?resize=980:*'} alt='Home Background' style={{objectFit:'cover'}} width='100%' height='100%'/>
           <Grid container>
            ...
            <div style={{padding:'20px'}}>
                <Typography align='center' style={{borderRadius:30,color:'white', marginBottom:'10vh',padding:10, backgroundColor:'#5F4C4C'}} className={classes.marg} variant='h5'>Featured Products</Typography>
